# InfraTales | Network Function Virtualization – Telecom-Grade NFV on AWS

**Production-ready reference architecture for virtualized network functions with service chaining and orchestration.**

> **NFV platform with virtualized network functions: firewalls, load balancers, IDS/IPS, DPI, service chaining, and orchestration for telecom-grade services**
